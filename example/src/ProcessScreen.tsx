...
import TestidSDKReact, { HyperFragmentView } from 'hola-sdk-react';
      ...
      <View style={styles.containerNew}>
        ...
        <CustomButton2
          ...
          onPress={() => {
            ...
            TestidSDKReact.process(JSON.stringify(payload));
          }}
        />
      </View>
    );
              ...
              <View>
                ...
                <CustomButton
                  ...
                  onPress={() => {
                    ...
                    TestidSDKReact.processWithActivity(JSON.stringify(payload));
                  }}
                /> */}
          ...
          {/* <View style={styles.containerSon2}>
            <CustomButton3
              ...
              onPress={() => {
                ...
                TestidSDKReact.process(JSON.stringify(data));
              }}
            />
          </View> */}
        </View>
